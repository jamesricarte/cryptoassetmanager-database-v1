        ...
        <table>
            ...
            <?php 
                    ...
                    while ($rowlogs = $resultlogs->fetch_assoc()) {
                        ...
                        echo "<table class='table-logs-info'>
                        <thead>
                        <tr>
                            <td>Coin Name</td>
                            ...
                            <td class='header-current-price'>Current Price</td>
                            <td class='header-current-value'>Current Value</td>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            ...
                            <td class='current-price'>₱". number_format(round($pricelogs, 2), 2, '.', ',') ."</td>
                            <td class='current-value-td'><p class='current-value'>₱". number_format(round($numberlogs*$pricelogs, 2), 2, '.', ',')  ."</p></td>
                            <td class='logs-delete-button-td'><a href='delete_edit-page.php?id=$rowlogs[id]'>
